    ...
    {!user && <>
      ...
      <section className="py-20">
        <div className="w-full">
          <div className="w-full bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 border border-primary/20 p-10 md:p-14 text-center shadow-2xl space-y-6">
