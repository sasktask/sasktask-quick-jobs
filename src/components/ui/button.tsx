  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-border bg-background hover:bg-muted/50 hover:border-primary/50 hover:-translate-y-0.5",
        ...
        premium: "bg-gradient-primary text-primary-foreground shadow-colored hover:shadow-glow hover:-translate-y-1 hover:scale-[1.02] relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-700",
        "premium-outline": "border-2 border-primary/30 bg-primary/5 text-primary hover:bg-primary/10 hover:border-primary/50 hover:-translate-y-0.5",
        "premium-ghost": "text-primary hover:bg-primary/10 hover:-translate-y-0.5",
        success: "bg-success text-success-foreground shadow-md hover:shadow-lg hover:-translate-y-0.5",
        glass: "glass text-foreground hover:bg-background/80 hover:-translate-y-0.5 border border-border/50",
      },
      size: {
